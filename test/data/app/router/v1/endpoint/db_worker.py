...
@router.get("/db_worker/search_company")
...
@router.put("/db_worker/update_company")
def update_company_api(company: UpdateCompany):
    try:
        ...
        result = update_company(collection, company.company_name, company.company_url)
        return result
...
@router.delete("/db_worker/delete_company")
...
@router.get("/db_worker/get_all_companies")
...
@router.get("/db_worker/search_page")
...
@router.post("/db_worker/add_new_page")
...
@router.put("/db_worker/update_page")
...
@router.delete("/db_worker/delete_page")
...
@router.delete("/db_worker/delete_all_company_homepage")
...
@router.delete("/db_worker/delete_all_reviews")
