...
@router.get("/vector_db_worker/search_company")
...
@router.delete("/vector_db_worker/delete_company")
...
@router.get("/vector_db_worker/get_company_documents")
...
@router.get("/vector_db_worker/search_document")
...
@router.put("/vector_db_worker/update_document")
...
@router.delete("/vector_db_worker/delete_document")
...
@router.get("/vector_db_worker/similarity_search_with_score")
...
@router.get("/vector_db_worker/similarity_search_with_relevance_scores")
